...
import CreatePostModel from '../Post/CreatePostModel'; // Add the correct path
import SearchComponents from '../../Components/SearchComponents/SearchUserCard'; // Add the correct path
